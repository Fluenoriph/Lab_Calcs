...
data_library = {
    ...
    "Размер главного окна": QtCore.QSize(1285, 725),
    "Текущий период": QtCore.QDate(2025, 1, 1),
    "Ориентация": QtCore.Qt.Orientation.Horizontal,
    "Расстояние по умолчанию": (125, 25, QtCore.QSize(900, 300), 90, 15),
    "Расстояние максимальное": (200, 55, QtCore.QSize(1200, 400), 200, 35),
