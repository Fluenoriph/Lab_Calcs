...
data_library = {
    ...
    "Калькуляторы": {
        ...
        "Учет влияния фонового шума": {
            ...
            "Результаты": ("дБ | Гц", "Общий уровень", "Фоновый уровень", "Разность с фоном", "С поправкой на фон"),
    ...
    "Журналы": {
        "Основной регистратор": {
            "Параметры": ("Номер протокола", "Дата проведения измерений", "Дата выпуска протокола", "Бюджет/внебюджет",
