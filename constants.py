...
data_library = {
    ...
    "Справка": "1.  Расчет единичного измерения массовой концентрации взвешенных веществ в атмосферном воздухе.\n"
                    "РД 52.04.893-2020 «Массовая концентрация взвешенных веществ в пробах атмосферного воздуха. "
    ...
    "Размер представления": QtCore.QSize(1050, 500),
    "Размер главного окна": QtCore.QSize(1180, 675),
    "Ориентация": QtCore.Qt.Orientation.Horizontal,
    "Расстояние по умолчанию": (125, 25, QtCore.QSize(900, 300), 50, 15),
    "Расстояние максимальное": (200, 55, QtCore.QSize(1200, 400), 100, 35),
    ...
    "Журналы": {
        ...
        "Радиационные факторы": {
            "Параметры": ("МЭД гамма-излучения", "ОА радона", "ЭРОА радона", "ПП радона"),
